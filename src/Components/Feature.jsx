  ...
  return (
    <div id='features'>
      ...
      <div className='a-container'>
        <Featurebox image={fimage1} title="WeightLifting" content=""/>
        <Featurebox image={fimage2} title="Specific Muscle" content="Can you train specific muscles?
If you're training for general fitness, that balances all the different muscle groups. If you're training for a sport, you may benefit from emphasizing certain muscle groups frequently used in your sport."/>
